...
const editorConfig = {
    ...
    MENU_CONF: {
        uploadImage: {
            server: `${import.meta.env.VITE_API_URL}/api/auth/blog/uploadImg`,
            fieldName: 'file',
            ...
            customInsert(res, insertFn) {
                insertFn(`${import.meta.env.VITE_API_URL}/api/base/getBlogImg/${res.filename}?id=${store.data.userId}`)
            },
        }
    }
}
